...
//plotting dots
 var circles = svg.selectAll(".dot")
    ...
    .enter().append("circle")
      ...
      .style("stroke", function(d) { if (d.type_2 == "" ) {return color(d.type_1)} else {return color(d.type_2)}; })
      .on("mouseover", function(d) {    //mouseover function, tooltip 
            ...
            div.html("<img src='/data/images/" + d.pokeid + ".png' style='width:90px;height:90px;'><br><a class='pname'>" + d.pokename + 
                      ...
                      d.special_attack + "<br/>Special Defense: " + d.special_defense + "<br/>Speed: " + d.speed + "</p>")  
